...
public class ProgrammingStreams6 {
	...
	public static void main(String[] args) {
		...
		System.out.println(people.stream().filter(ProgrammingStreams6::isOlderThan25)
		...
		System.out.println(
				people.stream().filter(ProgrammingStreams6::isOlderThan25)
						.filter(person -> person.getName().length() == 4));
		// since the terminal operation is missing
	}
}